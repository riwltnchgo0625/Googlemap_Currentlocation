package com.example.googlemapcurrentlocation.view;
...
import com.example.googlemapcurrentlocation.R;
import com.example.googlemapcurrentlocation.api.BaseApiService;
import com.example.googlemapcurrentlocation.api.Server;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    private int PLACE_PICKER_REQUEST = 10000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Google Map Sample");
        Button btnPickPlace = findViewById(R.id.btnPlacePicker);
